...
$.ajax({
    ...
    data: {
        key: 'IG2BZ-UGHLV-WNKP7-5MQPK-HROGH-LEBEE',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(113.447215, 23.384022, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
